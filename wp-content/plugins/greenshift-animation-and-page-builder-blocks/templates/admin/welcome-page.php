...
<div class="wrap gspb_welcome_div_container">
    ...
    <nav class="nav-tab-wrapper">
        <div>
            <a href="?page=greenshift_dashboard" class="nav-tab nav-tab-active">
        ...
        <div class="gs_grid">
            ...
            <div class="gs_grid_2">
                <div class="greenshift_form">
                    ...
                    <div class="gs_main_text"><a href="https://www.youtube.com/watch?v=00ebtAX-a34" target="_blank"><?php esc_html_e("Overview of design options", 'greenshift-animation-and-page-builder-blocks'); ?></a></div>
